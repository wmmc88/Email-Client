/**
 * Created by Melvin Wang on 2016-05-13.
 */
public class Utils {
    ...
    public static boolean isANumber(String s) {
        ...
        for (int i = 0; i < s.length() && isANumber; i++) {
            isANumber = Character.isDigit(s.charAt(i));
        }
        return isANumber && s.length() != 0;
    }
    ...
    public static String intToBytesStr(int num) {
        return ("" + (char) (num >> 24) + (char) ((num & 0xFF0000) >> 16) + (char) ((num & 0xFF00) >> 8) + (char) (num & 0xFF));
    }
